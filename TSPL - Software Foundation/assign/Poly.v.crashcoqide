...
Proof.
  ...
  - (* rev (rev []) = [] *)
    reflexivity.
  - (* rev (rev (x :: l)) = x :: l *)
    simpl. rewrite rev_app_distr, IHl. simpl.
    reflexivity.
Qed.
...
Lemma map_dist : forall (X Y : Type) (f : X -> Y) (l : list X) (x : X),
...
(**  The solution uses [unfold], which we haven't explained yet!! 
 *)
...
(** $Date: 2016-01-04 20:04:32 +0000 (Mon, 04 Jan 2016) $ *)
