...
apply (cut_tac P="\<lambda>x. \<not> (Member x x)" in comprehension)
apply (erule exE)
...
apply (cut_tac member_iff_not_member)
apply (erule exE)
apply (cut_tac P="Member y y" in excluded_middle)
apply (erule disjE)
apply (rule_tac P="Member y y" in notE)
apply assumption
apply (erule iffD2)
apply assumption
apply (rule_tac P="Member y y" in notE)
