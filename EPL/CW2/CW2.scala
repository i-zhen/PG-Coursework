  ...
  */
  ...
  object MyPrinter extends Printer{
    ...
    def append(x:Doc, y: Doc) = {
      (lev : Int, ifSus: Boolean) => x(lev, ifSus) + y(lev, ifSus)
    }

    def nest(i: Int, doc: Doc) = {
      (lev : Int, ifSus: Boolean) => doc(lev + i, ifSus)
    }

    def unnest(doc: Doc) = {
      (lev : Int, ifSus: Boolean) => doc(lev, true)
    }
  ...
  /*======================================================================
   The rest of this file is support code
   ====================================================================== */
  /* ===== MiniMD Parser ===== */
